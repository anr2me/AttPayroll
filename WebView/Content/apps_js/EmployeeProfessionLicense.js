$(document).ready(function () {
    ...
    function UpdateEnable(objId, isEnabled) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: base_url + "EmployeeProfessionLicense/UpdateEnable?isEnabled=" + isEnabled,
            data: JSON.stringify({
                Id: objId
            }),
    ...
    function ReloadGridViewChildren(id) {
        ...
        $("#list_detail").jqGrid({
            url: base_url + 'EmployeeProfessionLicense/GetList?Id=' + id,
            //postData: { 'ParentId': function () { return $("#parenttype").val(); } },
            datatype: "json",
    ...
    $('#btn_edit').click(function () {
        ...
        if (id) {
            ...
            $.ajax({
                dataType: "json",
                url: base_url + "EmployeeProfessionLicense/GetInfo?Id=" + id,
    ...
    $('#delete_confirm_btn_submit').click(function () {
        ...
        $.ajax({
            url: base_url + "EmployeeProfessionLicense/Delete",
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify({
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'EmployeeProfessionLicense/Update';
        }
            // Insert
        else {
            submitURL = base_url + 'EmployeeProfessionLicense/Insert';
        }
