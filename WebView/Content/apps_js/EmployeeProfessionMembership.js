$(document).ready(function () {
    ...
    function UpdateEnable(objId, isEnabled) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: base_url + "EmployeeProfessionMembership/UpdateEnable?isEnabled=" + isEnabled,
            data: JSON.stringify({
                Id: objId
            }),
    ...
    function ReloadGridViewChildren(id) {
        ...
        $("#list_detail").jqGrid({
            url: base_url + 'EmployeeProfessionMembership/GetList?Id=' + id,
            //postData: { 'ParentId': function () { return $("#parenttype").val(); } },
            datatype: "json",
            colNames: ['ID', 'EmployeePersonal ID', 'EmployeePersonal NIK', 'EmployeePersonal Name', 'Nama PT', 'Jangka Waktu', 'Jabatan Terakhir', 'Is Deleted', 'Created At', 'Updated At'],
            colModel: [
                      { name: 'id', index: 'id', width: 80, align: "center", frozen:true },
                      ...
                      { name: 'namapt', index: 'namapt', width: 100, frozen: true, },
                      { name: 'jangkawaktu', index: 'jangkawaktu', width: 100 },
                      { name: 'jabatanterakhir', index: 'jabatanterakhir', width: 100 },
    ...
    $('#btn_edit').click(function () {
        ...
        if (id) {
            ...
            $.ajax({
                dataType: "json",
                url: base_url + "EmployeeProfessionMembership/GetInfo?Id=" + id,
    ...
    $('#delete_confirm_btn_submit').click(function () {
        ...
        $.ajax({
            url: base_url + "EmployeeProfessionMembership/Delete",
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify({
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'EmployeeProfessionMembership/Update';
        }
            // Insert
        else {
            submitURL = base_url + 'EmployeeProfessionMembership/Insert';
        }
        ...
        $.ajax({
            ...
            url: submitURL,
            data: JSON.stringify({
                Id: id, EmployeePersonalId: jQuery("#list").jqGrid('getGridParam', 'selrow'), //IsEnabled: document.getElementById("IsEnabled").checked ? 'true' : 'false',
