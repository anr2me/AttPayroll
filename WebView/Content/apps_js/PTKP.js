$(document).ready(function () {
    ...
    function ReloadGrid() {
        ...
        $("#list").setGridParam({ url: base_url + 'PTKP/GetList', postData: { filters: null, ParentId: value }, page: '1' }).trigger("reloadGrid");
    }
    ...
    //    $.ajax({
    //        dataType: "json",
    //        url: base_url + 'PTKP/GetListDepartment?Id=' + branchID,
    //        async: false,
    ...
    //GRID +++++++++++++++
    $("#list").jqGrid({
        url: base_url + 'PTKP/GetList',
        postData: { 'ParentId': function () { return $("#parenttype").val(); } },
        datatype: "json",
        colNames: ['ID', 'Code', 'Amount', 'Description', 'Created At', 'Updated At'],
        colModel: [
    			  { name: 'id', index: 'id', width: 80, align: "center" },
                  { name: 'code', index: 'code', width: 100 },
				  { name: 'amount', index: 'amount', width: 180 },
    ...
    $('#btn_edit').click(function () {
        ...
        if (id) {
            ...
            $.ajax({
                dataType: "json",
                url: base_url + "PTKP/GetInfo?Id=" + id,
                success: function (result) {
                    if (result.Id == null) {
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'PTKP/Update';
        }
            // Insert
        else {
            submitURL = base_url + 'PTKP/Insert';
        }
        ...
        $.ajax({
            ...
            url: submitURL,
            data: JSON.stringify({
                Id: id, Code: $("#Code").val(), Amount: $("#Amount").numberbox('getValue'), Description: $("#Description").val(),
            }),
            async: false,
            cache: false,
            timeout: 30000,
