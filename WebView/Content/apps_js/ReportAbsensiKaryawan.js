$(document).ready(function () {
    ...
    $('#btn_print').click(function () {
        window.open(base_url + 'Report/ReportAbsensiKaryawan?startDate=' + $('#StartDate').datebox('getValue') + '&endDate=' + $('#EndDate').datebox('getValue') + '&Id=' + $('#EmployeeId').val() + '&ChartType=' + $('#ChartType').val());
    });
