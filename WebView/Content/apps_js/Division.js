$(document).ready(function () {
    ...
    function ReloadGrid() {
        ...
        $("#list").setGridParam({ url: base_url + 'Division/GetList', postData: { filters: null, ParentId: value }, page: 'first' }).trigger("reloadGrid");
    }
    ...
    $("#parenttype").change(function () { //live("change", function () {
        ReloadGrid();
    });
    ...
    //GRID +++++++++++++++
    $("#list").jqGrid({
        url: base_url + 'Division/GetList',
        postData: { 'ParentId': function () { return $("#parenttype").val(); } },
        datatype: "json",
        colNames: ['ID', 'Code', 'Name', 'Description', 'Department Id', 'Department Code', 'Department Name', 'Created At', 'Updated At'],
        colModel: [
                  ...
                  { name: 'departmentname', index: 'departmentname', width: 180, hidden: true },
    ...
    $('#btn_edit').click(function () {
        ...
        if (id) {
            ...
            $.ajax({
                dataType: "json",
                url: base_url + "Division/GetInfo?Id=" + id,
                success: function (result) {
                    if (result.Id == null) {
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'Division/Update';
        }
            // Insert
        else {
            submitURL = base_url + 'Division/Insert';
        }
