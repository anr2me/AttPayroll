$(document).ready(function () {
    ...
    function ReloadGridListParent() {
        ...
        jQuery("#list").jqGrid({
            ...
            datatype: "json",
            colNames: ['ID', 'Title ID', 'JobDesc Title'],
            colModel: [
    ...
    function ReloadGridViewChildren(id) {
        ...
        $("#list_detail").jqGrid({
            url: base_url + 'JobDescAssignment/GetList?Id=' + id,
            //postData: { 'ParentId': function () { return $("#parenttype").val(); } },
            datatype: "json",
            colNames: ['ID', 'JobDesc ID', 'JobDesc Name', 'Employee ID', 'Employee Name', 'EmployeePersonal ID', 'Division ID', 'Division Name', 'Superior ID', 'Superior Name', 'Supervisor ID', 'Supervisor Name', 'Location', 'Effective Date', 'Is Deleted', 'Created At', 'Updated At'],
            colModel: [
                      { name: 'id', index: 'id', width: 80, align: "center", frozen: true },
                      { name: 'jobdescid', index: 'jobdescid', width: 100, frozen: true, hidden: true },
                      { name: 'jobdescname', index: 'jobdescname', width: 100, frozen: true, hidden: true },
                      { name: 'applicantid', index: 'applicantid', width: 100, frozen: true, hidden: true },
                      { name: 'applicantname', index: 'applicantname', width: 100, frozen: true },
                      { name: 'employeepersonalid', index: 'employeepersonalid', width: 100, frozen: true, hidden: true },
                      { name: 'divisionid', index: 'divisionid', width: 100, frozen: true, hidden: true },
                      { name: 'divisionname', index: 'divisionname', width: 100 },
                      { name: 'superiorid', index: 'superiorid', width: 100, frozen: true, hidden: true },
                      { name: 'superiorname', index: 'superiorname', width: 100 },
                      { name: 'supervisorid', index: 'supervisorid', width: 100, frozen: true, hidden: true },
    ...
    $('#btn_edit').click(function () {
        ...
        if (id) {
            ...
            $.ajax({
                dataType: "json",
                url: base_url + "JobDescAssignment/GetInfo?Id=" + id,
