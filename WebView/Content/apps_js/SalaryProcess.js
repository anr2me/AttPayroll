$(document).ready(function () {
    ...
    function onAllEmployee() {
        if (document.getElementById('IsAllEmployee').checked) {
    ...
    document.getElementById('IsAllEmployee').onchange = function () {
        onAllEmployee();
    };
    ...
    $('#btn_print').click(function () {
        $.ajax({
            dataType: "json",
            url: base_url + 'SalaryProcess/DoProcess?Id=' + $('#EmployeeId').val() + '&IsAllEmployee=' + (document.getElementById('IsAllEmployee').checked ? 'true' : 'false') + '&StartPeriod=' + $('#StartPeriod').datebox('getValue') + '&EndPeriod=' + $('#EndPeriod').datebox('getValue'),
            success: function (result) {
                if (JSON.stringify(result.Errors) != '{}') {
                    ...
                    $.messager.alert('Success', 'Salary has been processed', 'info');
                }
            }
        });
    });
