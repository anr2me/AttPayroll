$(document).ready(function () {
    ...
    function UpdateEnable(objId, isEnabled) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: base_url + "EmployeeEducationMini/UpdateEnable?isEnabled=" + isEnabled,
            data: JSON.stringify({
                Id: objId
            }),
    ...
    function ReloadGridViewChildren(id) {
        ...
        $("#list_detail").jqGrid({
            url: base_url + 'EmployeeEducationMini/GetList?Id=' + id,
            //postData: { 'ParentId': function () { return $("#parenttype").val(); } },
            datatype: "json",
            colNames: ['ID', 'EmployeePersonal ID', 'EmployeePersonal NIK', 'EmployeePersonal Name', 'Nama Sekolah', 'Alamat', 'Tahun', 'Is Deleted', 'Created At', 'Updated At'],
            colModel: [
                      { name: 'id', index: 'id', width: 80, align: "center", frozen:true },
                      ...
                      { name: 'namasekolah', index: 'namasekolah', width: 100, frozen: true, },
                      { name: 'alamat', index: 'alamat', width: 100 },
                      { name: 'tahun', index: 'tahun', width: 100 },
    ...
    $('#btn_edit').click(function () {
        ...
        if (id) {
            ...
            $.ajax({
                dataType: "json",
                url: base_url + "EmployeeEducationMini/GetInfo?Id=" + id,
    ...
    $('#delete_confirm_btn_submit').click(function () {
        ...
        $.ajax({
            url: base_url + "EmployeeEducationMini/Delete",
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify({
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'EmployeeEducationMini/Update';
        }
            // Insert
        else {
            submitURL = base_url + 'EmployeeEducationMini/Insert';
        }
