$(document).ready(function () {
    ...
    function ReloadGridViewChildren(id) {
        ...
        $("#list_detail").jqGrid({
            url: base_url + 'KRA/GetList?Id=' + id,
            //postData: { 'ParentId': function () { return $("#parenttype").val(); } },
            datatype: "json",
            colNames: ['ID', 'JobDesc ID', 'JobDesc Name', 'Key Result Area'],
            colModel: [
                      ...
                      { name: 'keyresultarea', index: 'keyresultarea', width: 250, frozen: true },
            ],
            page: '1',
            pager: $('#pager_detail'),
            rowNum: 20,
    ...
    $('#btn_edit').click(function () {
        ...
        if (id) {
            ...
            $.ajax({
                dataType: "json",
                url: base_url + "KRA/GetInfo?Id=" + id,
                success: function (ret) {
                    ...
                    if (result.Id == null) {
                        ...
                        if (JSON.stringify(result.Errors) != '{}') {
                            ...
                            $('#KeyResultArea').val(result.KeyResultArea);
