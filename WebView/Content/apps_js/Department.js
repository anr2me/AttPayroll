$(document).ready(function () {
    ...
    function ReloadGrid() {
        ...
        $("#list").setGridParam({ url: base_url + 'Department/GetList', postData: { filters: null, ParentId: value }, page: 'first' }).trigger("reloadGrid");
    }
    ...
    //GRID +++++++++++++++
    $("#list").jqGrid({
        url: base_url + 'Department/GetList',
        postData: { 'ParentId': function () { return $("#parenttype").val(); } },
        datatype: "json",
        colNames: ['ID', 'Code', 'Name', 'Description', 'BranchOffice Id', 'BranchOffice Code', 'BranchOffice Name', 'Created At', 'Updated At'],
        colModel: [
    			  { name: 'id', index: 'id', width: 80, align: "center" },
                  { name: 'code', index: 'code', width: 100 },
				  { name: 'name', index: 'name', width: 180 },
                  { name: 'description', index: 'description', width: 250 },
                  { name: 'branchofficeid', index: 'branchofficeid', width: 100, hidden:true },
                  { name: 'branchofficecode', index: 'branchofficecode', width: 150, hidden: true },
                  { name: 'branchofficename', index: 'branchofficename', width: 180, hidden: true },
    ...
    $('#btn_edit').click(function () {
        ...
        if (id) {
            ...
            $.ajax({
                dataType: "json",
                url: base_url + "Department/GetInfo?Id=" + id,
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'Department/Update';
        }
            // Insert
        else {
            submitURL = base_url + 'Department/Insert';
        }
